...
const statics = ArStatics
const paragraph = ArParagraph
const explicit = ArExplicit
const prepare_implicit = ArPrepareImplicit
const resolve_weak = ArResolveWeak
const resolve_neutral = ArResolveNeutral
const resolve_implicit = ArResolveImplicit
const reorder_resolved = ArReorderResolved
